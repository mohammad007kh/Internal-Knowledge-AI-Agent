...
export function TriggerSyncButton({ sourceId, currentJobId }: TriggerSyncButtonProps) {
  ...
  return (
    ...
    >
      <RefreshCw size={14} aria-hidden="true" className={isRunning ? 'animate-spin' : undefined} />
